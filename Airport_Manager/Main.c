...
int initManagerAndCompany(AirportManager* pManager, Company* pCompany, const char* managerFile, const char* companyFile)
{
	int res = initManager(pManager, managerFile);
	if (!res)
	{
